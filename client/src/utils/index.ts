...
import heroVidMed from "../assets/landing/videos/medium.mp4"
import heroVidSmall from "../assets/landing/videos/small.mp4"
...
export const heroVidLagSrc = heroVidLag
export const heroVidMedSrc = heroVidMed
export const heroVidSmallSrc = heroVidSmall

// Export Apple icon
export const appleImg = apple

// Export feature images
export const featureImg1 = feature1
export const featureImg2 = feature2
export const featureImg3 = feature3
export const featureImg4 = feature4
export const featureImg5 = feature5
export const featureImg6 = feature6
export const featureImg7 = feature7
export const featureImg8 = feature8

// Export product landing images
export const ip16proImg = ip16pro
export const ip16Img = ip16
export const ip16eImg = ip16e
export const ip15Img = ip15

// Export product specification images
export const a18Img = a18
export const a18proImg = a18pro
export const a16Img = a16
export const batteryImg = battery
export const cam16proImg = cam16pro
export const cam16Img = cam16
export const cam16eImg = cam16e
