  ...
  return (
    <footer className="bg-gray-50 border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div id="title-container" className="flex items-center text-sm text-gray-600 mb-8 pb-4 border-b border-gray-200">
        ...
        <div id="footer-item" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-8 mb-8">
